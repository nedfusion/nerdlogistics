  ...
  const services = [
    {
      ...
      title: 'Long Haul Freight Services',
      description: 'Interstate and cross-border haulage services for heavy and bulk goods using our well-maintained fleet of 30-tonne to 45-tonne trucks.',
      features: [
        '30-tonne to 45-tonne capacity trucks',
    ...
    },
    {
      ...
      title: 'Distribution and Delivery Solutions',
      description: 'Customized distribution services for FMCGs, manufacturing companies, and agricultural products, ensuring efficient market-to-market or warehouse-to-market deliveries.',
      features: [
        'FMCG distribution',
        'Manufacturing products delivery',
        'Agricultural products transport',
        'Market-to-market logistics',
      ],
    ...
    {
      icon: <Truck size={28} />,
      title: 'Dedicated Contract Haulage',
      description: 'Reliable long-term logistics partnerships tailored to your company\'s supply chain needs, with dedicated trucks and drivers.',
      features: [
      ...
      link: '/services/contract-haulage',
    ...
    },
    {
      ...
      description: 'Professional logistics consulting for businesses seeking to optimize their transportation and supply chain operations.',
      features: [
      ...
      imageSrc: 'https://images.pexels.com/photos/4481326/pexels-photo-4481326.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    },
  ];
